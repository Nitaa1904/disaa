<%-- 
    Document   : editform-info
    Created on : Jan 7, 2024, 1:26:28 PM
    Author     : Nita
--%>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #439A97;">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="berbagi.jsp">Berbagi</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="Login.jsp">Mulai</a>
                </li>
            </ul>
        </div>
    </nav> 
...
<%@page import="com.javatpoint.dao.InfoDao,com.javatpoint.bean.Info"%>  
  
<%  
String id=request.getParameter("id");  
Info u=InfoDao.getRecordById(Integer.parseInt(id));  
%>  

<div class="container">
    <h3 class="mt-4 mb-4" style="color: #439A97;">Edit Data Informasi</h3>  
    ...
    <table class="table">
      ...
      <tr>
        <td>Tanggal</td>
        <td>
          <input type="text" name="tanggal" value="<%= u.getTanggal()%>" class="form-control"/>
        </td>
      </tr>
      <tr>
        <td>Tempat</td>
        <td>
          <input type="text" name="tempat" value="<%= u.getTempat()%>" class="form-control"/>
        </td>
      </tr>
      <tr>
        <td>Deskripsi</td>
        <td>
          <input type="text" name="deskripsi" value="<%=u.getDeskripsi()%>" class="form-control"/>
        </td>
      </tr>
      <tr>
        <td colspan="2">
          <input type="submit" value="Edit Informasi" class="btn btn-primary" style="background-color: #439A97; 
                 color: #ffffff;"/>
          <a href="viewinfo.jsp" class="btn btn-primary" style="background-color: #186F65; border-color: #186F65; 
             color: #ffffff;">Batal</a>
        </td>
      </tr>
    </table>
  </form>
