<%-- 
    Document   : viewinfo
    Created on : Jan 7, 2024, 1:34:12 PM
    Author     : Nita
--%>
...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #439A97;">
    ...
    <%@page import="com.javatpoint.dao.InfoDao,com.javatpoint.bean.*,java.util.*"%>  
    ...
    <div class="container">
        ...
        <%  
        List<Info> list=InfoDao.getAllRecords();  
        ...
        <td><a class="mt-2 mb-2" href="editform-info.jsp?id=${u.getId()}" style="display: inline-block; 
               padding: 10px 20px; background-color: #439A97; color: #ffffff; text-decoration: none; text-align: 
               center; border-radius: 5px;">Edit</a></td>  
        <td><a href="deleteinfo.jsp?id=${u.getId()}" style="display: inline-block; padding: 10px 20px; 
               background-color: #BF3131; color: #ffffff; text-decoration: none; text-align: center; 
               border-radius: 5px;">Delete</a></td></tr>  
        </c:forEach>  
        </table>  
        <br/><a href="informasi.jsp" style="display: inline-block; padding: 10px 20px; background-color: #439A97; 
                color: #ffffff; text-decoration: none; text-align: center; border-radius: 5px;">Kembali</a><br/>  
    </div>
    <p class="mt-5"></br></br>
    <footer>
