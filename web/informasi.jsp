...
.event-box span a {
  ...
  <div class="container">
        ...
        <div class="col-md-6 mt-5">
            <h2 class="mt-5">
                <span style="padding: 70px;">
                    <b class="" style="color: #439A97;">Informasi Terkini</b>
                </span>
            </h2>
        </div>
    ...
    <div class="container">
     <a href="addinfoform.jsp" class="mb-4 mt-4" style="display: inline-block; padding: 10px 20px; background-color: #439A97; color: #ffffff; text-decoration: none; text-align: center; border-radius: 5px;">Add New Info</a>
     <a href="viewinfo.jsp" style="display: inline-block; padding: 10px 20px; background-color: #439A97; color: #ffffff; text-decoration: none; text-align: center; border-radius: 5px;">Modifikasi Data</a><br/>
    </div>
            ...
            <div class="aligned-text row mb-4">
                ...
                <div class="card mb-5 ">
                    <div class="card-body" style="display: inline-block; border: 2px solid white; padding: 45px; border-radius: 10px; margin-right: 20px; width: 254px; background-color: white;">                               
                        ...
                        <% out.println(tanggal); %> </br></br>
                        <% out.println(tempat); %><br><br>
                        <a href="lihatdetail-info.jsp?id=<%= rs2.getInt("id") %>" class="btn btn-info lihat-detail">Lihat Detail</a>
                    </div>
                </div>
