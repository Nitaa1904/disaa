...
try {
    ...
    String query = "SELECT * FROM wisata WHERE id = ?";
        ...
        <div class="col-md-6 mt-5">
            <h2 class="mt-5">
                <span style="padding: 70px;">
                    <b class="" style="color: #439A97;">Detail Destinasi</b>
                </span>
            </h2>
        </div>
    </div>
...
<div class="container">
     <a href="kumpulan wisata.jsp" class="mb-4" style="display: inline-block; padding: 10px 20px; 
        background-color: #439A97; color: #ffffff; text-decoration: none; text-align: center; border-radius: 5px;">Kembali</a>
</div>                    
