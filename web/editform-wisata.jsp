...
<%@page import="com.javatpoint.dao.WisataDao,com.javatpoint.bean.Wisata"%>  
  
<%  
String id=request.getParameter("id");  
Wisata u=WisataDao.getRecordById(Integer.parseInt(id));  
%>  

<div class="container">
    <h3 class="mt-4 mb-4" style="color: #439A97;">Edit Data Destinasi</h3>  
      <form action="editwisata.jsp" method="post">
    ...
    <table class="table">
      ...
      <tr>
        <td colspan="2">
          <input type="submit" value="Edit Destinasi" class="btn btn-primary" 
                 style="background-color: #439A97; color: #ffffff;"/>
          <a href="viewwisata.jsp" class="btn btn-primary" style="background-color: #186F65; 
             border-color: #186F65; color: #ffffff;">Batal</a>
        </td>
      </tr>
    </table>
  </form>
